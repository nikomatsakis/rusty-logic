...
-- Get free type parameters in a type (TODO: fix termination proof)  
...
-- Get free type parameters in a substitution (TODO: depends on freeVars)
...
-- Apply substitution to a type (TODO: fix termination proof)
...
-- Apply capture-avoiding substitution to where clauses (TODO: depends on applySubst)
...
-- Apply substitution to a list of where clauses (TODO: depends on applySubstWhere)
